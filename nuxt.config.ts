...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      titleTemplate: `%s - ${siteConfig.brandTitle}`,
      meta: [
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { name: 'description', content: siteConfig.description },
        { name: 'keywords', content: siteConfig.keywords.join(',') },
        { name: 'application-name', content: siteConfig.brandTitle },
        { name: 'apple-mobile-web-app-title', content: siteConfig.brandTitle },
        {
          name: 'referrer',
          content: 'strict-origin-when-cross-origin',
        },
        { name: 'theme-color', content: '#ffffff' },
        { property: 'og:title', content: siteConfig.brandTitle },
        { property: 'og:type', content: 'website' },
        { property: 'og:site_name', content: siteConfig.brandTitle },
        ...
        { property: 'og:image:alt', content: `${siteConfig.brandTitle} share preview` },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: siteConfig.brandTitle },
